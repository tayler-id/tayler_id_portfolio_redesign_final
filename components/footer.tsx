      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <motion.div
            ...
            transition={noAnimation ? { duration: 0 } : { duration: 0.6, delay: 0.2 }}
          ...
          >
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                transition={noAnimation ? { duration: 0 } : { delay: index * 0.1 + 0.4, duration: 0.5 }}
        ...
        {/* Animated Particles - only show when motion is enabled */}
        {!noAnimation && (

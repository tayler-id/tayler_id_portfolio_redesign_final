...
*   **Frontend (To Be Determined):**
    *   Will be deployed to a static hosting provider (e.g., GitHub Pages, Netlify, Vercel).
    *   This typically involves pushing the static files (`src/` directory and related assets) to the provider.
    *   The chosen platform will have its own deployment mechanisms (e.g., Git-based deployment).
